...
const LoginPage = () => {
  return (
    <div className='flex justify-center items-center bg-gray-100 p-6 pt-0 mt-8'>
      <div className="flex justify-center items-center w-full">
        <div className="flex flex-col lg:flex-row w-full max-w-[1080px] lg:h-[550px] rounded-lg shadow-lg overflow-hidden">
          ...
          <div className="w-full lg:w-1/2 bg-white text-black p-10 flex flex-col justify-center gap-8 lg:gap-10">
